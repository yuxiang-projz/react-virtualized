...
test(
  'will react to header height updates if notified through updatePosition',
...
test(
  'will NOT react to header height updates if notified through updatePosition if `updateScrollTopOnUpdatePosition` is false',
  /*#__PURE__*/ (0, _asyncToGenerator2['default'])(
...
test(
  'will properly process scroll events after header height updates',
  /*#__PURE__*/ (0, _asyncToGenerator2['default'])(
