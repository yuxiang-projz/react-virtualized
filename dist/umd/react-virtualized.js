          ...
          exact: function(shapeTypes) {
            return createChainableTypeChecker(function(
              ...
              for (var key in allKeys) {
                var checker = shapeTypes[key];
                if (has(shapeTypes, key) && 'function' != typeof checker)
                  return invalidValidatorError(
                    componentName,
                    location,
                    propFullName,
